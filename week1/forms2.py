...
class ProfileForm(forms.Form):
    ...
    profession = forms.CharField(max_length=200, required=True, label=_("Profession"), label_suffix="")
    worksAt = forms.CharField(max_length=100, required=False, label=_("Independent/company name"), label_suffix="")
    city = forms.CharField(max_length=100, required=False, label=_("City"), label_suffix="")
    education = forms.CharField(max_length=200, required=False, label=_("Education"), label_suffix="")
    birthdate = forms.DateField(required=False, label=_("Birth date"), label_suffix="")
    #birthdate = forms.DateField(required=False, widget=forms.DateInput(format = '%m-%d-%Y'), input_formats=('%m-%d-%Y',), label=_("Birth date"))
    language = forms.CharField(max_length=200, required=False, label=_("Language"), label_suffix="")
...
class Step2(forms.Form):
    describe = forms.CharField(max_length=500, required=False, widget=forms.Textarea(attrs={'rows':5, 'cols':65}), label=_("Describe yourself"), label_suffix="")
...
class PersonalInfo(forms.Form):
    city = forms.CharField(max_length=100, required=False, label=_("City"), label_suffix="")
    worksAt = forms.CharField(max_length=100, required=False, label=_("Independent/Company name"), label_suffix="")
    education = forms.CharField(max_length=100, required=False, label=_("Education"), label_suffix="")
    language = forms.CharField(max_length=100, required=False, label=_("Language"), label_suffix="")
    skill1 = forms.CharField(max_length=200, required=False)
    skill2 = forms.CharField(max_length=200, required=False)
    skill3 = forms.CharField(max_length=200, required=False)
